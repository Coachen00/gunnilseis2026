    ...
    },
    {
      ...
      sessions: [
        ...
        },
        {
          day: "Onsdag",
          date: "10/6",
          title: "Vecka 5 – Onsdag – Fyll boxen",
          purpose: "Tre+ spelare i box vid inspel.",
          principle: "Fyll på i/runt box.",
          activation: "Fyll boxen utan boll.",
          ...
          progression: "Begränsa inspelstid — kräver att boxen fylls snabbare.",
...
export const PERIOD_1_PRINCIPLES: Principle[] = [
  ...
  },
  {
    ...
    detail:
      "YF isolerad i 1v1 in i assistytan + cutback till 9, bortre YF och 8 som fyller box. Inspel ska kombineras med att boxen fylls — annars är arbetet bortkastat.",
    graphic: "final-third",
  },
  {
    slug: "boxfyllnad",
