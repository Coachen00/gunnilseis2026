...
const FemUpphojtFem = lazy(() => import("./pages/FemUpphojtFem"));
...
const Semestern2026 = lazy(() => import("./pages/Semestern2026"));
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/semestern-2026" element={<Protected routeName="Semestern 2026"><Semestern2026 /></Protected>} />
