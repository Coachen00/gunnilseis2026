  ...
  <>
    ...
    <div className="container pb-section space-y-16">
      <SectionReveal as="section">
        ...
        <div className="bg-card rounded-lg p-6 border border-border text-sm text-muted-foreground">Vad upprepar sig — bra som dåligt — över de senaste matcherna?</div>
      </SectionReveal>
      <SectionReveal as="section">
        <SectionHeader badge="Trend" title="KPI-trend" subtitle="PPDA · Spelvändningar · Inspel till assistytan" />
        <div className="bg-card rounded-lg p-6 border border-border text-sm text-muted-foreground">Sammanfatta trenden för de tre KPI:erna.</div>
      </SectionReveal>
      <SectionReveal as="section">
        <SectionHeader badge="Nästa steg" title="Vad fokuserar vi på framåt" />
        <div className="bg-card rounded-lg p-6 border border-border text-sm text-muted-foreground">Prioriterade utvecklingsområden för kommande träningsperiod.</div>
      </SectionReveal>
    </div>
  </>
);
