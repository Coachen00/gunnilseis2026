...
/* =========================================================================
   UNDER PROCESS — arbetsyta för principer som byggs vidare
   ========================================================================= */

const UNDER_PROCESS_PRINCIPLES = [
  {
...
function UnderProcessSection() {
  return (
    <section id="under-process" className="scroll-mt-24 border-b border-border bg-background py-16 md:py-20">
      <div className="container">
        <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="text-3xl font-black uppercase tracking-normal text-foreground md:text-5xl">
              Under process
            </h2>
          </div>
          <p className="max-w-xl text-sm leading-relaxed text-foreground/65 md:text-base">
            Principer som styr hur vi tränar, lär oss och flyttar matchens rytm dit vi vill.
          </p>
        </div>

        <Accordion type="single" collapsible defaultValue="huvudprinciper" className="overflow-hidden rounded-md border border-border bg-card">
            ...
            <AccordionTrigger className="px-4 py-4 text-left hover:no-underline md:px-6">
              <span className="flex w-full flex-col gap-2 pr-4 md:flex-row md:items-center md:justify-between">
                <span className="flex items-center gap-3">
                  ...
                  <span>
                    <span className="block text-xl font-black uppercase tracking-normal text-foreground md:text-2xl">
                      Huvudprinciper
                    </span>
            ...
            <AccordionContent className="border-t border-border bg-background px-4 pb-6 pt-5 md:px-6">
              <div className="grid grid-cols-1 gap-5 lg:grid-cols-[0.95fr_1.45fr]">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  {UNDER_PROCESS_PRINCIPLES.map((principle, index) => {
                    ...
                    return (
                      <article key={principle.title} className="border border-border bg-card p-5">
                        ...
                        <h3 className="text-lg font-black uppercase leading-tight tracking-normal text-foreground">
                          {principle.title}
                        </h3>
