    ...
    <div className="container pb-24 space-y-24">
      <section id="direkt" className="scroll-mt-24">
        ...
        <div className="mb-6 grid gap-3 md:grid-cols-3">
          <MediaSlot slotKey="spelmodell:omstallning-forsvar:direkt:press" title="Press" description="Direkt motpress - närmaste spelare" compact />
          <MediaSlot slotKey="spelmodell:omstallning-forsvar:direkt:stang" title="Stäng vägar" description="Direkt motpress - stäng passningsvägar" compact />
          <MediaSlot slotKey="spelmodell:omstallning-forsvar:direkt:atererovring" title="Återerövring" description="Direkt motpress - återerövring" compact />
        </div>
      ...
      <section id="kontroll" className="scroll-mt-24">
        ...
        <div className="mb-4 grid gap-3 md:grid-cols-3">
          <MediaSlot slotKey="spelmodell:omstallning-forsvar:kontroll:ned" title="Flytta ned" description="Tillbaka till kontroll - flytta ned" compact />
          <MediaSlot slotKey="spelmodell:omstallning-forsvar:kontroll:centrera" title="Centrera" description="Tillbaka till kontroll - centrera" compact />
          <MediaSlot slotKey="spelmodell:omstallning-forsvar:kontroll:block" title="Block" description="Tillbaka till kontroll - kompakt block" compact />
        </div>
