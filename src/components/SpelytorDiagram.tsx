    ...
    <div className={cn("relative", className)}>
      ...
      <div className="mt-4 space-y-2">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-accent">Spelyta 3 – bakom deras backlinje (hot/avslut)</span>
        </div>
      </div>
      ...
      <div className="mt-4 p-3 rounded-lg bg-accent/10 border border-accent/20">
        <p className="text-xs text-accent font-medium text-center">
          <strong>Mål:</strong> Hitta rättvänd spelare i spelyta 2 — där öppnas spelvändning och djupledspass.
        </p>
      </div>
    </div>
  );
